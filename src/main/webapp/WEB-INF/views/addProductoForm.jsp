<%-- 
    Document   : addProductoForm
    Created on : 18-nov-2014, 23:02:41
    Author     : Emmanuel
--%>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message key="title.productos.add"/></h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form:form action="${pageContext.request.contextPath}/producto/add/${producto.id}.htm" commandName="pProducto" method="POST" modelAttribute="producto">
                                    <div class="form-group">
                                        <table class="table table-responsive">
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outCodeBar" path="codigo_barras" type="test" required="true" class="form-control" placeHolder="Captura el Codigo de Barras"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outCodeProd" path="clave_desc" type="test" required="true" class="form-control" placeHolder="Captura el codigo de producto"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outNomProd" path="nombre" type="test" required="true" class="form-control" placeHolder="Captura el nombre del producto"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outDescProd" path="descripcion" type="test" required="true" class="form-control" placeHolder="Captura la descripcion del Producto"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outMarcaProd" path="marca" type="test" required="true" class="form-control" placeHolder="Captura la marca del producto"/>
                                                </td>
                                            </tr>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outMarcaProd" path="existencia" type="test" required="true" class="form-control" placeHolder="Captura las Existencias del producto"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outPrecioCProd" path="precio_compra" type="test" required="true" class="form-control" placeHolder="Captura el precio de compra"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outIvaProd" path="iva" type="test" class="form-control" placeHolder="Captura el IVA"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-lg-8">
                                                    <form:input id="outIepsProd" path="ieps" type="test" class="form-control" placeHolder="Captura el IEPS"/>
                                                </td>
                                            </tr>	
                                            <tr>
                                                <td>&nbsp;</td>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="panel-body">
                                                <input type="submit" class="btn btn-primary btn-lg" value="Agregar Producto"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="panel-body">
